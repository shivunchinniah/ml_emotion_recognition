...
if 'sampled_df' not in st.session_state or st.button("Reshuffle Samples 🎲"):
    st.session_state.sampled_df = create_sample_df(df_full, SAMPLES_PER_CLASS)
    st.session_state.inspection_results = {} # Reset results on reshuffle
...
if report_data:
    ...
    st.sidebar.download_button(
        ...
        data=csv_report,
        file_name='fer2013_inspection_report.csv',
        mime='text/csv',
    )
else:
